package com.example.plantgrowingapp.local.database
...
/**
 * A database that stores data information.
...
abstract class PlantGrowingDatabase : RoomDatabase() {
     ...
     *
     * For example, clients can call `PlantGrowingDatabase.getInstance(context)` to instantiate
     * a new PlantGrowingDatabase.
     */
    companion object {
        /**
         ...
         */
        @Volatile
        private lateinit var INSTANCE: PlantGrowingDatabase
         ...
         */
        fun getInstance(context: Context): PlantGrowingDatabase {
            ...
            synchronized(this) {
                ...
                if (!::INSTANCE.isInitialized) {
                    INSTANCE = Room.databaseBuilder(
                        ...
                        PlantGrowingDatabase::class.java,
                        "plant_growing_database"
                    )
